...
<section className="parallax relative w-full h-[100vh] flex flex-col justify-center items-center text-center  overflow-hidden">
      ...
      <div ref={imageRef} className='absolute top-0 left-0 bottom-0 overflow-hidden z-1  flex flex-col justify-center items-center w-[100%] h-[200%] left-0' style={{ backgroundImage: "url('/voice.jpg')", backgroundSize:'cover', backgroundPosition:'center',backgroundRepeat: 'no-repeat' }}>
...
<div ref={sectionRef} className="relative flex min-h-screen flex-col items-center justify-start  bg-[#EEF0FF]">
  <div ref={titleRef}>
    <h1  className=" text-6xl  pt-[60px] text-center font-[500] text-[#6210FF] animate__animated animate__fadeInUp">Our Services</h1>
    </div>
    ...
    <div  ref={card2Ref} className="absolute top-[100%] z-10 bg-white rounded-[30px] shadow-2xl max-w-[1200px] w-full md:flex overflow-hidden">
      ...
      <div className="p-8 md:w-1/2 flex flex-col">
        <h2 className="text-4xl font-normal text-gray-900 mb-4">Performance Marketing</h2>
