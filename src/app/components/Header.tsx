      ...
      <header className=" mx-auto fixed top-0 w-full flex justify-between items-center px-4 sm:px-6 py-3 sm:py-4 bg-transparent backdrop-blur-lg text-white z-50">
        <div className="text-3xl sm:text-4xl md:text-5xl font-semibold tracking-wide">
          <svg width="94" height="52" viewBox="0 0 94 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M89.5638 0.0498047C87.9863 6.333 82.3 10.9801 75.5319 10.9801C68.7637 10.9801 63.0721 6.333 61.5 0.0498047H67.2822C68.6518 3.24736 71.8281 5.49097 75.5319 5.49097C79.2357 5.49097 82.4119 3.24736 83.7815 0.0498047H89.5638Z" fill="white" />
            <path d="M53.6465 0.0498047L35.2233 45.8921C33.9283 49.1216 30.7947 51.2373 27.3147 51.2373C23.8347 51.2373 20.7065 49.1216 19.4061 45.8921L0.988281 0.0498047H10.0586L26.5846 41.1597C26.8511 41.8258 27.7943 41.8258 28.0608 41.1597L44.5761 0.0498047H53.6518H53.6465Z" fill="white" />
          </svg>
        </div>

        <button
          onClick={toggleMenu}
          className="w-9 h-9 sm:w-10 sm:h-10 cursor-pointer rounded-full border border-white flex items-center justify-center hover:bg-white/10 transition-colors duration-200"
        >
        ...
        >
          ...
          <div className="flex justify-between items-center px-4 sm:px-6 py-3 sm:py-4 pt-8">
            <div className="text-3xl sm:text-4xl md:text-5xl font-semibold tracking-wide text-white">
              <svg width="94" height="52" viewBox="0 0 94 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M75.5327 15.2539C65.5458 15.2539 57.4453 23.3544 57.4453 33.3414C57.4453 43.3284 65.5458 51.4289 75.5327 51.4289C79.7748 51.4289 83.6758 49.9687 86.7561 47.5279V51.4289H93.6202V33.1655C93.5242 23.2638 85.4611 15.2592 75.5327 15.2592V15.2539ZM75.5327 44.5648C69.3348 44.5648 64.3094 39.5393 64.3094 33.3414C64.3094 27.1435 69.3348 22.118 75.5327 22.118C81.7306 22.118 86.7561 27.1435 86.7561 33.3414C86.7561 39.5393 81.7306 44.5648 75.5327 44.5648Z" fill="white" />
                <path d="M89.5638 0.238281C87.9863 6.52147 82.3 11.1686 75.5319 11.1686C68.7637 11.1686 63.0721 6.52147 61.5 0.238281H67.2822C68.6518 3.43583 71.8281 5.67945 75.5319 5.67945C79.2357 5.67945 82.4119 3.43583 83.7815 0.238281H89.5638Z" fill="white" />
                <path d="M53.6465 0.238281L35.2233 46.0805C33.9283 49.3101 30.7947 51.4258 27.3147 51.4258C23.8347 51.4258 20.7065 49.3101 19.4061 46.0805L0.988281 0.238281H10.0586L26.5846 41.3482C26.8511 42.0143 27.7943 42.0143 28.0608 41.3482L44.5761 0.238281H53.6518H53.6465Z" fill="white" />
              </svg>
            </div>
          ...
          <div className="px-6 pb-8">
            <div className={`w-16 sm:w-24 h-0.5 bg-gradient-to-r from-white/50 to-transparent ml-auto transition-all duration-500 ${isMenuOpen ? 'opacity-100 scale-x-100' : 'opacity-0 scale-x-0'
              }`} style={{ transitionDelay: isMenuOpen ? '800ms' : '0ms' }}></div>
          </div>
        </div>
      </div>
    </>
