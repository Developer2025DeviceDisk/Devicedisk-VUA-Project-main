      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-lg max-w-none text-black space-y-8">
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">We may use your personal information you submit to the Site to:</p>
          ...
          <section>
            ...
            <p>1203, B-3, Rosa Oasis, G. B. Road, Kasarvadavali, Thane, Maharashtra, 400615</p>
            <p>Email: <a href="mailto:reachus@vvworx.com" className="text-[#6210FF] hover:underline">reachus@vvworx.com</a></p>
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">The following links explain how to block cookies in your browser:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>How to block cookies in Internet Explorer – <a href="http://windows.microsoft.com/en-US/windows-vista/Block-or-allow-cookies" className="text-[#6210FF] hover:underline">http://windows.microsoft.com/en-US/windows-vista/Block-or-allow-cookies</a></li>
              <li>How to block cookies in Chrome – <a href="https://support.google.com/chrome/bin/answer.py?hl=en&answer=95647&p=cpn_cookies" className="text-[#6210FF] hover:underline">https://support.google.com/chrome/bin/answer.py?hl=en&answer=95647&p=cpn_cookies</a></li>
              <li>How to block cookies in Firefox – <a href="http://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences" className="text-[#6210FF] hover:underline">http://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences</a></li>
              <li>How to block cookies in Safari – <a href="https://support.apple.com/en-in/guide/safari/sfri11471/mac" className="text-[#6210FF] hover:underline">https://support.apple.com/en-in/guide/safari/sfri11471/mac</a></li>
            </ul>
          </section>
